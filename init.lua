...
require("lazy").setup({
	...
	{
		"dev4dev/blade-snippets",
		ft = { "blade", "php" }, -- Add file types
		config = function()
			vim.g.snip_enable = true
	...
	--NOTE: LARAVEL FILES
	-- Laravel specific plugin for extra commands and integration
	{
		"noahfrederick/vim-laravel",
		event = "BufReadPre *.php", -- lazy load for PHP files
	},
	-- Another popular Laravel plugin written in Lua
	{
		"jwalton512/vim-blade",
		ft = "blade", -- Ensure Blade files are detected
		config = function()
			-- Optional: You can customize vim-blade settings here if needed.
			vim.g.blade_php_mode = 1 -- Enable Blade PHP mode
		end,
	},
	-- Laravel.nvim: helper plugin with lots of Laravel features
	{
		"ThePrimeagen/harpoon", -- optional, but nice for navigation
	},
	{
		"tpope/vim-dispatch", -- async dispatch, useful for artisan commands
	},
	{
